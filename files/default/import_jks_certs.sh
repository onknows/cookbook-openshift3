...
function import_certs() {
  dir=$CERT_DIR
  hawkular_metrics_keystore_password=$METRICS_KEYSTORE_PASSWD
  hawkular_cassandra_keystore_password=$CASSANDRA_KEYSTORE_PASSWD
  hawkular_metrics_truststore_password=$METRICS_TRUSTSTORE_PASSWD
  hawkular_cassandra_truststore_password=$CASSANDRA_TRUSTSTORE_PASSWD
