if node['cookbook-openshift3']['control_upgrade']
  ...
  if node['cookbook-openshift3']['openshift_deployment_type'] == 'enterprise'
    ...
    when '15'
      ...
      default['cookbook-openshift3']['upgrade_ose_version'] = '3.5.5.31.47-1.git.0.25d535c.el7'
      default['cookbook-openshift3']['upgrade_openshift_docker_image_version'] = 'v3.5.5.31.47'
    when '36'
      default['cookbook-openshift3']['upgrade_ose_major_version'] = '3.6'
      default['cookbook-openshift3']['upgrade_ose_version'] = '3.6.173.0.63-1.git.0.855ea8b.el7'
      default['cookbook-openshift3']['upgrade_openshift_docker_image_version'] = 'v3.6.173.0.63'
    when '37'
